...
# Standard Out
# Format: -o <file_name>
#SBATCH -o dev_apologies13.stdout

# Standard Error
# Format: -e <file_name>
#SBATCH -e dev_apologies13.stderr
...
#SBATCH -A mistakes -p tier3 --nodes=1 --ntasks-per-node=1 --cpus-per-task=1
...
echo "Doing stuff..."
time python3 -u scripts/aggregate_stats.py data_aps_json/
date
