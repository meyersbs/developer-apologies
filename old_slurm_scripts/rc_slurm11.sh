...
# Standard Out
# Format: -o <file_name>
#SBATCH -o dev_apologies11.stdout

# Standard Error
# Format: -e <file_name>
#SBATCH -e dev_apologies11.stderr
...
#SBATCH -A mistakes -p tier3 --nodes=1 --ntasks-per-node=12 --cpus-per-task=1
...
echo "Doing stuff..."
time python3 -u main.py apology_stats data_aps/ 12
date
