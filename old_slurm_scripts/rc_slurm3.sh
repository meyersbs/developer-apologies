...
# Standard Out
# Format: -o <file_name>
#SBATCH -o dev_apologies3.stdout

# Standard Error
# Format: -e <file_name>
#SBATCH -e dev_apologies3.stderr
...
#echo "Loading Elixir..."
#date
#time python3 -u main.py load experiment.hdf5 data_850_stars/Elixir/ --append
#time python3 -u main.py info_hdf5 experiment.hdf5

#echo "Loading Lua..."
#date
#time python3 -u main.py load experiment.hdf5 data_850_stars/Lua/ --append
#time python3 -u main.py info_hdf5 experiment.hdf5
